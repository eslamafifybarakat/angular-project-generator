...
function root(fixture: ComponentFixture<DropdownComponent>): HTMLElement {
  return fixture.nativeElement as HTMLElement;
}

function trigger(fixture: ComponentFixture<DropdownComponent>): HTMLButtonElement {
  return root(fixture).querySelector('.dropdown__trigger') as HTMLButtonElement;
}

function options(fixture: ComponentFixture<DropdownComponent>): HTMLLIElement[] {
...
describe('DropdownComponent', () => {
  ...
  function setup(): ComponentFixture<DropdownComponent> {
