...
import { architectureExampleFiles } from '../../domain/architecture-registry';
import {
...
} from '../../domain/architecture.model';
...
export class ArchitectureStepComponent {
  ...
  protected readonly groupLabelKey = computed(() =>
    this.resolved().groupingLabel === 'domain' ? 'app.archGroupDomain' : 'app.archGroupFeature',
  );
