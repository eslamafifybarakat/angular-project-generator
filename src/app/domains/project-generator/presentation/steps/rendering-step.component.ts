...
@Component({
  ...
  templateUrl: './rendering-step.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RenderingStepComponent {
  ...
  protected readonly modes: readonly { value: RenderingMode; label: string; descKey: string }[] = [
    { value: 'ssr', label: 'SSR', descKey: 'app.ssrD' },
    { value: 'csr', label: 'CSR', descKey: 'app.csrD' },
    { value: 'hybrid', label: 'Hybrid', descKey: 'app.hybridD' },
  ];
