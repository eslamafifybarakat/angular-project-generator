...
export class GeneratorService {
  ...
  readonly stages = computed<readonly PipelineStage[]>(() => {
    ...
    return [
      ...
      { labelKey: 'angular_project_generator_generate_stage_2', detail: '', skipped: false },
      {
        labelKey: 'angular_project_generator_generate_stage_3',
        detail: profile ? `angular-${profile.version} · ${profile.era}` : `angular-${cfg.angular.version}`,
        skipped: false,
      },
      { labelKey: 'angular_project_generator_generate_stage_4', detail: cfg.architecture.pattern, skipped: false },
      { labelKey: 'angular_project_generator_generate_stage_5', detail: '', skipped: !anyCustomFeature },
      {
        labelKey: 'angular_project_generator_generate_stage_6',
        detail: cfg.theme.source === 'template' ? 'ddd-template' : 'default',
        skipped: false,
      },
      {
        labelKey: 'angular_project_generator_generate_stage_7',
        detail: cfg.localization.enabled ? cfg.localization.selectedLanguages.join('+') : '',
        skipped: !cfg.localization.enabled,
      },
      {
        labelKey: 'angular_project_generator_generate_stage_8',
        detail: `${cfg.environments.length}`,
        skipped: false,
      },
      { labelKey: 'angular_project_generator_generate_stage_9', detail: '', skipped: !cfg.seo.enabled },
      { labelKey: 'angular_project_generator_generate_stage_10', detail: '', skipped: false },
      { labelKey: 'angular_project_generator_generate_stage_11', detail: `${fileCount}`, skipped: false },
      { labelKey: 'angular_project_generator_generate_stage_12', detail: '', skipped: false },
      {
        labelKey: 'angular_project_generator_generate_stage_13',
